...
fgsea_plot <- function(res, sig_res=NULL, msigdb_species = "Homo sapiens", msigdb_cat = "H", gene_col = NULL, padj = 0.01, output_dir, tag) {
  ...
  ##it's always DESeq2 but allow this for future use of other packages
  rank_col <- "stat"
  sig_col <- ""
  ...
  ##select/arrange by that rank_col
